...
public class UserApiController {
	...
	public ResponseDto<Integer> save(@RequestBody BlogUser user) { // @RequestBody 어노테이션이 있어야 JSON 데이터를 받아올수있다. // user 로
																// 받는값 username, password, email
...
// 기본적인 로그인 기능 구현방법
	...
	public ResponseDto<Integer> login(@RequestBody BlogUser user, HttpSession session) {
		...
		BlogUser principal = userService.login(user); // principal(접근주체)
